...
from diff_logic_compact import build_gitlike_compact_analysis


class DiffStringsGitlikeCompactTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        string_a = str(tool_parameters.get("string_a") or "")
        string_b = str(tool_parameters.get("string_b") or "")
        result = build_gitlike_compact_analysis(string_a, string_b)
